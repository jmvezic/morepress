...
class __TwigTemplate_74ad1e3db94992e89f134b29fa973b225d33a9bef58cd5f87d9145735c783c8e extends Twig_Template
{
...
";
        ...
        if ( !twig_test_empty((isset($context["title"]) ? $context["title"] : $this->getContext($context, "title")))) {
            echo "<h2 class=\"card-title\"
                                    ";
            // line 7
            if ( !twig_test_empty((isset($context["titleAttributes"]) ? $context["titleAttributes"] : $this->getContext($context, "titleAttributes")))) {
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable((isset($context["titleAttributes"]) ? $context["titleAttributes"] : $this->getContext($context, "titleAttributes")));
    ...
    ";
        ...
        // line 14
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["sparklines"]) ? $context["sparklines"] : $this->getContext($context, "sparklines")));
        foreach ($context['_seq'] as $context["key"] => $context["sparkline"]) {
            ...
            if (($context["key"] % 2 == 0)) {
                // line 16
                echo "                    ";
                echo $context["macros"]->getsingleSparkline($context["sparkline"], (isset($context["allMetricsDocumentation"]) ? $context["allMetricsDocumentation"] : $this->getContext($context, "allMetricsDocumentation")), (isset($context["areSparklinesLinkable"]) ? $context["areSparklinesLinkable"] : $this->getContext($context, "areSparklinesLinkable")));
                echo "
                ";
            }
            // line 18
    ...
    ";
        // line 39
        if ((isset($context["areSparklinesLinkable"]) ? $context["areSparklinesLinkable"] : $this->getContext($context, "areSparklinesLinkable"))) {
            // line 40
            echo "        ";
    ...
    ";
        // line 43
        if ( !twig_test_empty((isset($context["footerMessage"]) ? $context["footerMessage"] : $this->getContext($context, "footerMessage")))) {
            // line 44
            echo "        <div class='datatableFooterMessage'>";
            echo (isset($context["footerMessage"]) ? $context["footerMessage"] : $this->getContext($context, "footerMessage"));
            echo "</div>
    ";
        }
        // line 46
...
{% endif %}", "@CoreVisualizations/_dataTableViz_sparklines.twig", "/home/morepress/www/piwik/plugins/CoreVisualizations/templates/_dataTableViz_sparklines.twig");
    }
}
