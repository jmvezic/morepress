...
class __TwigTemplate_af5f7e1fc911a2d38491205c1c8c734ad6f5e084ea882c24bde488d8c69f4961 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_visualization_only", array())) {
            ...
            // line 5
            $context["isDataTableEmpty"] = (twig_test_empty((isset($context["dataTable"]) ? $context["dataTable"] : $this->getContext($context, "dataTable"))) || ((array_key_exists("dataTableHasNoData", $context)) ? (_twig_default_filter((isset($context["dataTableHasNoData"]) ? $context["dataTableHasNoData"] : $this->getContext($context, "dataTableHasNoData")), false)) : (false)));
            // line 6
            echo "
";
            // line 7
            $context["showCardAsContentBlock"] = (($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_as_content_block", array()) && $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_title", array())) &&  !(isset($context["isWidget"]) ? $context["isWidget"] : $this->getContext($context, "isWidget")));
            // line 8
            $context["showOnlyTitleWithoutCard"] = (( !(isset($context["showCardAsContentBlock"]) ? $context["showCardAsContentBlock"] : $this->getContext($context, "showCardAsContentBlock")) && $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "title", array())) && $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_title", array()));
            // line 9
            echo "
";
            // line 10
            if ((isset($context["showCardAsContentBlock"]) ? $context["showCardAsContentBlock"] : $this->getContext($context, "showCardAsContentBlock"))) {
                // line 11
                echo "<div class=\"card\">
<div class=\"card-content\">
    ";
                // line 13
                if ($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "title", array())) {
                    // line 14
                    echo "        <h2 class=\"card-title\"
            ";
                    // line 15
                    if ($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "title_edit_entity_url", array())) {
                        echo "edit-url=\"";
                        echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "title_edit_entity_url", array()), "html", null, true);
                        echo "\"";
                    }
                    // line 16
...
(isset($context["showOnlyTitleWithoutCard"]) ? $context["showOnlyTitleWithoutCard"] : $this->getContext($context, "showOnlyTitleWithoutCard"))) {
                // line 20
                echo "    <div>
    <h2>";
                // line 21
...
";
            // line 24
            $context["showCardTableIsEmpty"] = (( !$this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_as_content_block", array()) && (isset($context["isDataTableEmpty"]) ? $context["isDataTableEmpty"] : $this->getContext($context, "isDataTableEmpty"))) &&  !(isset($context["isWidget"]) ? $context["isWidget"] : $this->getContext($context, "isWidget")));
            // line 25
            if ((isset($context["showCardTableIsEmpty"]) ? $context["showCardTableIsEmpty"] : $this->getContext($context, "showCardTableIsEmpty"))) {
                // line 26
                echo "    <div class=\"card\">
    <div class=\"card-content\">
";
...
";
    ...
    ";
            // line 39
            if ($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "description", array())) {
                // line 40
                echo "        <div class=\"card-description\">";
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "description", array()), "html", null, true);
                echo "</div>
    ";
            }
            // line 42
    ...
    <div class=\"reportDocumentation\">
        ";
            ...
            // line 45
            echo "        ";
            if ((array_key_exists("reportLastUpdatedMessage", $context) && (isset($context["reportLastUpdatedMessage"]) ? $context["reportLastUpdatedMessage"] : $this->getContext($context, "reportLastUpdatedMessage")))) {
    ...
    <div class=\"dataTableWrapper\">
        ...
        ";
                ...
                // line 52
                echo "            ";
                if ((isset($context["isDataTableEmpty"]) ? $context["isDataTableEmpty"] : $this->getContext($context, "isDataTableEmpty"))) {
                    // line 53
            ...
            ";
                    ...
                    // line 61
                    echo "                ";
                    $this->loadTemplate((isset($context["visualizationTemplate"]) ? $context["visualizationTemplate"] : $this->getContext($context, "visualizationTemplate")), "@CoreHome/_dataTable.twig", 61)->display($context);
                    // line 62
                    echo "            ";
                }
                // line 63
...
{%- endif %}", "@CoreHome/_dataTable.twig", "/home/morepress/www/piwik/plugins/CoreHome/templates/_dataTable.twig");
    }
}
