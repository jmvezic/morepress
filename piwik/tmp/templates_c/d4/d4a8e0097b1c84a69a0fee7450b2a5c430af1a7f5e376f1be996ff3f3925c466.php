...
/* @CoreHome/_menu.twig */
class __TwigTemplate_b9b727cace896af60b8b538c6218c7a08e8dec569046db501d2a1ccb33c30a4b extends Twig_Template
{
                ...
                if ((isset($context["hasSubmenuItem"]) ? $context["hasSubmenuItem"] : $this->getContext($context, "hasSubmenuItem"))) {
                    ...
                    foreach ($context['_seq'] as $context["name"] => $context["urlParameters"]) {
                        ...
                        if ((twig_slice($this->env, $context["name"], 0, 1) != "_")) {
                            // line 25
                            echo "                                    <li ";
                            if (((($this->getAttribute($this->getAttribute($context["urlParameters"], "_url", array(), "any", false, true), "module", array(), "any", true, true) && ($this->getAttribute($this->getAttribute($context["urlParameters"], "_url", array()), "module", array()) == (isset($context["currentModule"]) ? $context["currentModule"] : $this->getContext($context, "currentModule")))) && $this->getAttribute($this->getAttribute($context["urlParameters"], "_url", array(), "any", false, true), "action", array(), "any", true, true)) && ($this->getAttribute($this->getAttribute($context["urlParameters"], "_url", array()), "action", array()) == (isset($context["currentAction"]) ? $context["currentAction"] : $this->getContext($context, "currentAction"))))) {
                                echo "class=\"active\"";
                            }
                            // line 26
                            echo "                                        role=\"menuitem\"
...
";
    ...
    {
        return "{% macro menu(menu, anchorlink, cssClass, currentModule, currentAction) %}
