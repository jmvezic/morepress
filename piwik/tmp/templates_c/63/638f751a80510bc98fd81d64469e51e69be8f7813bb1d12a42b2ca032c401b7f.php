...
class __TwigTemplate_fa28ce831839a34557dc5a81db84aa56b6d8cbae7c0108f3cd87ddb5c1dba94b extends Twig_Template
{
...
";
    ...
    ";
            ...
            if ( !($this->getAttribute($this->getAttribute((isset($context["labelMetadata"]) ? $context["labelMetadata"] : $this->getContext($context, "labelMetadata")), $this->getAttribute($context["value"], "word", array()), array(), "array"), "url", array()) === false)) {
                // line 8
                echo "        <a href=\"";
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["labelMetadata"]) ? $context["labelMetadata"] : $this->getContext($context, "labelMetadata")), $this->getAttribute($context["value"], "word", array()), array(), "array"), "url", array()), "html", null, true);
    ...
    ";
            ...
            if ( !($this->getAttribute($this->getAttribute((isset($context["labelMetadata"]) ? $context["labelMetadata"] : $this->getContext($context, "labelMetadata")), $this->getAttribute($context["value"], "word", array()), array(), "array"), "logo", array()) === false)) {
                // line 11
                echo "        <img src=\"";
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["labelMetadata"]) ? $context["labelMetadata"] : $this->getContext($context, "labelMetadata")), $this->getAttribute($context["value"], "word", array()), array(), "array"), "logo", array()), "html", null, true);
                echo "\" width=\"";
...
";
    ...
    {
        return "{% set cloudColumn = properties.columns_to_display[1] %}
<div class=\"tagCloud\">
