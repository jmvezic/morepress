...
<link rel="stylesheet" href="{$baseUrl}/plugins/themes/morepress/css/screen.css?v=16" type="text/css" />
<link href="{$baseUrl}/plugins/themes/morepress/css/print.css" media="print" rel="stylesheet" type="text/css" />
<link href="{$baseUrl}/plugins/themes/morepress/css/style.css?v=4" rel="stylesheet" type="text/css" />
