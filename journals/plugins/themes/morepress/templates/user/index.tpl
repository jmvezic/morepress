...
{foreach from=$userJournals item=journal}
	...
	<table width="100%" class="info">
		<tr class="tableHeading">
			<th>{translate key="common.userPages"}</th>
			<th>{translate key="common.assign"}</th>
			<th>{translate key="common.review"}</th>
			<th>{translate key="common.edit"}</th>
			<th>{translate key="common.frequentTasks"}</th>
		</tr>
