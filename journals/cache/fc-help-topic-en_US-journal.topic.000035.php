<?php return array (
  ...
  array (
    ...
    array (
      ...
      'value' => '<p>The Records page keeps track of users making payments, payment type, time of payment, and other details.</p>',
    ),
  ),
); ?>