<?php return array (
  ...
  'manager.setup.authorCopyrightNoticeAgree' => 'Require authors to agree to the Copyright Notice in the submission process.',
  'manager.setup.authorCopyrightNoticeDescription' => 'The Copyright Notice will appear in About the Journal. It should describe for readers and authors whether the copyright holder is the author, journal, or a third party. It should include additional licensing agreements (e.g. <a href="https://creativecommons.org" target="_new" class="action">Creative Commons</a> licenses) that grant rights to readers (see <a href="{$sampleCopyrightWordingUrl}" target="_new" class="action">examples</a>), and it should provide the means for securing permissions, if necessary, for the use of the journal\'s content.',
  ...
  'manager.setup.competingInterests.description' => 'Biomedical journals typically require authors and reviewers to declare if they have any competing interests with regard to their research (see <a href="http://www.plosbiology.org/static/competing.action" target="_new">PLoS Policy</a>).',
  ...
  'manager.setup.permissions.priorAgreement' => 'Prior Agreement',
  ...
  'manager.setup.confirmResetLicense' => 'Are you sure you wish to reset the license and copyright information attached to published content to the license configured in Journal Setup?',
  'manager.setup.confirmResetLicenseChanged' => 'You have changed the license and copyright information in Journal Setup. Please save these changes before resetting the permissions.',
  'manager.setup.copyrightNotice' => 'Copyright notice',
  'manager.setup.copyrightYearBasis' => 'Base new article\'s copyright year on',
  'manager.setup.copyrightYearBasis.Article' => 'Default year will be drawn from the article\'s publication date, as in "publish-as-you-go".',
  'manager.setup.copyrightYearBasis.Issue' => 'Default year will be drawn from the issue\'s publication date.',
  ...
  'manager.setup.enablePageNumber' => 'Page numbers for items will be calculated and entered manually in the Table of Contents (e.g., 13-26).',
  ...
  'manager.setup.subjectClassificationURLValid' => 'Please provide a valid remote URL (include http://).',
  ...
  'manager.statistics.defaultMetricDescription' => 'Your journal is configured to record more than one usage metric. Usage statistics will be displayed in severeral contexts.
  ...
  'manager.statistics.reports.optionalColumns.description' => 'Items in italic and marked with * represent data that is optional to the current way of counting statistics in OJS (metric type). You might have that data or not, depending on your statistics plugin configuration.',
  ...
  'manager.statistics.reports.defaultReport.issueDownloads' => 'Issue file downloads',
  'manager.statistics.reports.defaultReport.issueTableOfContents' => 'Issue table of contents page views',
  'manager.statistics.reports.defaultReport.issueTableOfContentsAndDownloads' => 'Issue table of contents and downloads',
  ...
  'manager.statistics.reports.advancedOptions.label' => 'Customize columns, filter and ordering options. Changing any of these options might change the expected report template result.',
  ...
  'manager.statistics.reports.reportUrl.label' => 'The following url can be used to generate the report with this current form settings. Just copy it, paste into your browser and enter. You can use your favorites to store your custom report url generator.',
  'manager.statistics.reports.filters.byContext' => 'By context',
  'manager.statistics.reports.filters.byContext.description' => 'Narrow results by context (issue and/or article).',
  'manager.statistics.reports.filters.byObject' => 'By object type and/or object id',
  'manager.statistics.reports.filters.byObject.description' => 'Narrow results by object type (journal, issue, article, pdf galleys, other galleys) and/or by one or more object id(s).',
  ...
  'manager.subscriptions.form.dateRemindedBefore' => 'Pre-expiry Reminder Sent',
  'manager.subscriptions.form.dateRemindedAfter' => 'Post-expiry Reminder Sent',
