<?php return array (
  ...
  'user.authorization.pressManagerRequired' => 'A user with a Press Manager role (i.e. Press or Production Editor) must be assigned to the stage before you can proceed.',
  ...
  'user.profile.form.hashInvalid' => 'The password reset hash you attempted to use is not valid.',
  ...
  'user.login.changePasswordInstructionsOneStep' => 'You must choose a new password before you can log in to this site.<br /><br />Please enter your username and your new password below to change the password for your account.',
  ...
  'user.login.implicitAuth' => 'Shibboleth Login',
  'user.login.implicitAuthLogin' => 'Login via Shibboleth',
  'user.login.localAuth' => 'Local Account Login',
  'user.logOut' => 'Logout',
  'user.hello' => 'Hello,',
  ...
  'user.register.completeForm' => 'Fill in this form to register with this site.',
); ?>