<?php return array (
  ...
  array (
    ...
    array (
      ...
      'value' => '<p>Open Journal Systems is an open source application that can be freely downloaded and installed on nearly any desktop or server computer.</p>',
    ),
    1 => 
    array (
      'attributes' => 
      ...
      'value' => '<p>OJS is distributed under the terms of the <a href="http://www.gnu.org/copyleft/gpl.html" target="_blank">GNU General Public License</a>. A copy of the license terms for redistributing OJS code in original or modified form is included with the OJS download.</p>',
    ),
    2 => 
    array (
      'attributes' => 
    ...
    array (
      ...
      'value' => '<p>OJS can be downloaded from the Public Knowledge Project <a href="http://pkp.sfu.ca/ojs/" target="_blank">web site</a>.</p>',
    ),
    4 => 
    array (
      'attributes' => 
      ...
      'value' => '<p>OJS comes with a web-based installation script that guides the system administrator through the installation process. Alternately, a command-line installation tool is available.</p>
		<ol>
			<li>
