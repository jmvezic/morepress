...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submission/editorDecision.tpl', 12, false),array('function', 'url', 'sectionEditor/submission/editorDecision.tpl', 18, false),array('function', 'html_options_translate', 'sectionEditor/submission/editorDecision.tpl', 21, false),array('function', 'icon', 'sectionEditor/submission/editorDecision.tpl', 48, false),array('modifier', 'escape', 'sectionEditor/submission/editorDecision.tpl', 23, false),array('modifier', 'date_format', 'sectionEditor/submission/editorDecision.tpl', 34, false),array('modifier', 'assign', 'sectionEditor/submission/editorDecision.tpl', 43, false),array('modifier', 'to_array', 'sectionEditor/submission/editorDecision.tpl', 91, false),array('modifier', 'count', 'sectionEditor/submission/editorDecision.tpl', 104, false),)), $this); ?>
...
" class="button" />
	...
	<?php if ($this->_tpl_vars['lastDecision'] == SUBMISSION_EDITOR_DECISION_RESUBMIT): ?>
			<td><input type="submit" name="resubmit" <?php if (! ( $this->_tpl_vars['editorRevisionExists'] || $this->_tpl_vars['authorRevisionExists'] || $this->_tpl_vars['reviewVersionExists'] )): ?>disabled="disabled" <?php endif; ?>value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "form.resubmit"), $this);?>
" class="button" /></td>
			<td>
