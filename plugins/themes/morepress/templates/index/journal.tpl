...
<script type="text/javascript" src="/plugins/themes/morepress/js/journalTabSwitch.js"></script>
...
<script type="text/javascript" src="/plugins/themes/morepress/js/JournalArchiveCollapser.js"></script>
{php}
	...
	foreach ($Values as $Iden) {
		foreach ($Issues as &$value) {
    			...
    			if ($IssueID == $Iden) {
    				...
    				$IssueURL = '/index.php/'.$ThisJournalPath.'/issue/view/'.$IssueID;
