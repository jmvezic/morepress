<?php return array (
  ...
  'contactEmail' => 'vesna@unizd.hr',
  'contactFax' => '',
  'contactName' => 'Vesna Kalajžić',
  'contactPhone' => '',
  'contributors' => 
  array (
  ),
...
Liburna
http://morepress.unizd.hr/index.php/liburna',
  'envelopeSender' => '',
  'fastTrackFee' => 0,
  ...
  'licenseURL' => '',
  'mailingAddress' => '<span>Sveučilište u Zadru</span><br /><span>Odjel za turizam i komunikacijske znanosti, Sveučilište u Zadru</span><br /><span>Ul. Dr. Franje Tuđmana 24i, 23 000 Zadar, Republika Hrvatska</span><br /><span>Tel. + 385 23 345 039</span><br /><span>Fax. +385 23 311 540</span><br /><span>e-adresa: liburna@unizd.hr</span>',
  'membershipFee' => 0,
  ...
  'supportEmail' => 'vesna@unizd.hr',
  'supportName' => 'Vesna Kalajžić',
  'supportPhone' => '',
  ...
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="/index.php/liburna/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="/index.php/liburna/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="/index.php/liburna/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="/index.php/index/login">log in</a> and begin the five-step process.',
  ),
  ...
  'contactAffiliation' => 
  array (
    'en_US' => 'University of Zadar',
    'hr_HR' => 'Sveučilište u Zadru',
  ),
  'contactTitle' => 
  array (
    'en_US' => 'ph.D.',
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  'description' => 
  array (
    'en_US' => 'International scientific journal for culture, toursim and communication',
    'hr_HR' => 'International scientific journal for culture, tourism and communication',
  ),
  ...
  array (
    ...
    array (
      ...
      'height' => 424,
      'mimeType' => 'image/jpeg',
      'dateUploaded' => '2017-02-08 10:38:22',
    ),
    'hr_HR' => 
    array (
      'name' => '335.jpg',
      ...
      'height' => 424,
      'mimeType' => 'image/jpeg',
      'dateUploaded' => '2017-02-08 10:23:56',
    ),
  ),
  ...
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="/index.php/liburna/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="/index.php/liburna/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  array (
    ...
    array (
      ...
      4 => 
      array (
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="http://morepress.unizd.hr/index.php/liburna/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://morepress.unizd.hr/index.php/liburna/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a> have been followed.',
        'order' => '6',
      ),
    ),
  ),
