<?php /* Smarty version 2.6.26, created on 2017-02-01 10:33:03
         compiled from file:/home/morepress/www/plugins/citationFormats/proCite//citation.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'file:/home/morepress/www/plugins/citationFormats/proCite//citation.tpl', 12, false),array('modifier', 'to_array', 'file:/home/morepress/www/plugins/citationFormats/proCite//citation.tpl', 12, false),array('modifier', 'assign', 'file:/home/morepress/www/plugins/citationFormats/proCite//citation.tpl', 12, false),array('modifier', 'escape', 'file:/home/morepress/www/plugins/citationFormats/proCite//citation.tpl', 18, false),array('modifier', 'date_format', 'file:/home/morepress/www/plugins/citationFormats/proCite//citation.tpl', 21, false),array('modifier', 'strip_tags', 'file:/home/morepress/www/plugins/citationFormats/proCite//citation.tpl', 27, false),array('modifier', 'replace', 'file:/home/morepress/www/plugins/citationFormats/proCite//citation.tpl', 33, false),)), $this); ?>
...
PY  - <?php echo ((is_array($_tmp=$this->_tpl_vars['issue']->getDatePublished())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y") : smarty_modifier_date_format($_tmp, "%Y")); ?>

<?php else: ?>
PY  - <?php echo ((is_array($_tmp=$this->_tpl_vars['issue']->getYear())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
JF  - <?php echo $this->_tpl_vars['journal']->getLocalizedTitle(); ?>
<?php if ($this->_tpl_vars['issue']): ?>; <?php echo ((is_array($_tmp=$this->_tpl_vars['issue']->getIssueIdentification())) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
<?php endif; ?>
...
<?php endif; ?>
KW  - <?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getLocalizedSubject())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
