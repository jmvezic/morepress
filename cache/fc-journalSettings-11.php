<?php return array (
  ...
  'contactEmail' => 'izdavastvo@unizd.hr',
  'contactFax' => '',
  'contactName' => 'Sveučilište u Zadru',
  'contactPhone' => '',
  'contributors' => 
  array (
  ),
...
Acta Iadertina
http://morepress.unizd.hr/index.php/actaiadertina',
  'envelopeSender' => '',
  'fastTrackFee' => 0,
  'itemsPerPage' => 25,
  'journalTheme' => 'morepress',
  'mailingAddress' => '<p>Sveučilište u Zadru<br /> Mihovila Pavlinovića bb, 23000 Zadar<br /> http://www.unizd.hr/<br /> izdavastvo@unizd.hr</p>',
  'membershipFee' => 0,
  'metaCitations' => true,
  'numPageLinks' => 10,
  'numWeeksPerReview' => 4,
  'onlineIssn' => '1849-1243',
  'printIssn' => '1845-3392',
  'publicationFee' => 0,
  ...
  'supportEmail' => 'izdavastvo@unizd.hr',
  'supportName' => 'Sveučilište u Zadru',
  'supportPhone' => '',
  'useEditorialBoard' => false,
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="/index.php/actaiadertina/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="/index.php/actaiadertina/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="/index.php/actaiadertina/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="/index.php/index/login">log in</a> and begin the five-step process.',
  ),
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  array (
    'en_US' => 
    array (
      'name' => '1428399260-acta-iadertina-52008.jpg',
      'uploadName' => 'journalThumbnail_en_US.jpg',
      'width' => 400,
      'height' => 520,
      'mimeType' => 'image/jpeg',
      'dateUploaded' => '2017-02-10 09:17:53',
    ),
    'hr_HR' => 
    array (
      'name' => '1428399260-acta-iadertina-52008.jpg',
      ...
      'height' => 520,
      'mimeType' => 'image/jpeg',
      'dateUploaded' => '2017-02-10 09:17:08',
    ),
  ),
  ...
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="/index.php/actaiadertina/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="/index.php/actaiadertina/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  array (
    ...
    array (
      ...
      4 => 
      array (
        'content' => 'The text adheres to the stylistic and bibliographic requirements outlined in the <a href="http://morepress.unizd.hr/index.php/actaiadertina/about/submissions#authorGuidelines" target="_new">Author Guidelines</a>, which is found in About the Journal.',
        'order' => '5',
      ),
      5 => 
      array (
        'content' => 'If submitting to a peer-reviewed section of the journal, the instructions in <a href="javascript:openHelp(\'http://morepress.unizd.hr/index.php/actaiadertina/help/view/editorial/topic/000044\')">Ensuring a Blind Review</a> have been followed.',
        'order' => '6',
      ),
    ),
  ),
  ...
  'title' => 
  array (
    'en_US' => 'Acta Iadertina',
    'hr_HR' => 'Acta Iadertina',
  ),
  'waiverPolicy' => 
  array (
