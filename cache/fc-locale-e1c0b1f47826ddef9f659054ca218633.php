<?php return array (
  'manager.announcements' => 'Novosti',
  'manager.announcements.confirmDelete' => 'Jeste li sigurni da želite trajno izbrisati ovu novost?',
  'manager.announcements.create' => 'Kreiraj novu novost',
  'manager.announcements.createTitle' => 'Kreiraj',
  'manager.announcements.dateExpire' => 'Istek',
  'manager.announcements.edit' => 'Uredi novost',
  ...
  'manager.announcements.form.dateExpireInstructions' => 'Novost će biti prikazana čitateljima do ovog datuma. Ostavite prazno želite li da novost bude prikazana bez vremenskog ograničenja.',
  ...
  'manager.announcements.form.dateExpireValid' => 'Molimo odaberite ispravan datum isteka novosti.',
  ...
  'manager.announcements.form.description' => 'Tekst novosti',
  'manager.announcements.form.descriptionInstructions' => 'Pun tekst novosti',
  'manager.announcements.form.descriptionRequired' => 'Opis novosti je obavezan.',
  'manager.announcements.form.descriptionShortInstructions' => 'Kratak opis pojavljuje se uz naslov novosti.',
  'manager.announcements.form.descriptionShortRequired' => 'Kratki opis novosti je obavezan.',
  'manager.announcements.form.descriptionShort' => 'Kratak opis',
  'manager.announcements.form.notificationToggle' => 'Pošalji novost',
  'manager.announcements.form.notificationToggleInstructions' => 'Stvaranje nove novosti nakon spremanja ove najave.',
  'manager.announcements.form.saveAndCreateAnother' => 'Spremi i kreiraj još',
  'manager.announcements.form.titleRequired' => 'Naslov novosti je obavezan.',
  'manager.announcements.form.title' => 'Naslov',
  'manager.announcements.form.typeId' => 'Tip',
  'manager.announcements.form.typeIdValid' => 'Molimo odaberite ispravan tip novosti.',
  'manager.announcements.noneCreated' => 'Nema kreiranih novosti.',
  'manager.announcements.title' => 'Naslov',
  'manager.announcementTypes' => 'Tipovi novosti',
  'manager.announcementTypes.confirmDelete' => 'Upozorenje! Sve novosti ovoga tipa će biti izbrisane. Jeste li sigurni da želite nastaviti i obrisati ovaj tip novosti?',
  'manager.announcementTypes.create' => 'Kreiraj tip novosti',
  ...
  'manager.announcementTypes.form.typeNameExists' => 'Tip novosti s ovim imenom već postoji.',
  'manager.announcementTypes.form.typeName' => 'Naziv',
  'manager.announcementTypes.form.typeNameRequired' => 'Ime tipa novosti je obavezno.',
  'manager.announcementTypes.noneCreated' => 'Nema kreiranih tipova novosti.',
  'manager.announcementTypes.typeName' => 'Tip novosti',
  'manager.announcements.type' => 'Tip novosti',
