<?php return array (
  ...
  'admin.settings.security.plugins' => 'Prevent journal managers from installing, updating or deleting plugins.',
  'admin.settings.options' => 'Options',
  'admin.settings.useAlphalist' => 'For sites with many journals, show an alphalist on the homepage allowing for quick alphabetical navigation between journals.',
  ...
  'admin.settings.defaultMetricDescription' => 'Your OJS installation is configured to record more than one usage metric. Usage statistics will be displayed in severeral contexts.
  ...
  'admin.languages.reloadDefaultEmailTemplates' => 'Reload Default Email Templates',
...
Usage (processing all files of a directory): {$scriptName} path/to/apache/directory
Usage (processing all files of a directory whose names start with the passed string): {$scriptName} path/to/apache/directory starts_with_string',
